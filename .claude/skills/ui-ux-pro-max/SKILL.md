...
The search script lives inside this skill's own directory (`.claude/skills/ui-ux-pro-max/scripts/search.py`), relative to the repo root. Invoke it with that path regardless of the current working directory:
